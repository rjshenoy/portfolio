...
Q_CONSTINIT static const qt_meta_stringdata_CLASSboardENDCLASS_t qt_meta_stringdata_CLASSboardENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 7),  // "endTurn"
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 7)   // "endGame"
    },
    "board",
    "endTurn",
    "",
...
void board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (board::*)();
            if (_t _q_method = &board::endTurn; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (board::*)();
            if (_t _q_method = &board::endGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
