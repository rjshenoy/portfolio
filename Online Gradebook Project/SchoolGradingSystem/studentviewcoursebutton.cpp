...
void studentviewcoursebutton::onViewButtonClicked()
{
    emit this->viewCourseButtonClicked(this->course);
}

studentviewcoursebutton::studentviewcoursebutton(Course *c, int x, int y)
{
    // Create widget
    this->course = c;
    ...
    connect(viewButton, &QPushButton::clicked, this, &studentviewcoursebutton::onViewButtonClicked);
